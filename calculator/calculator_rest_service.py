...
calculation = api.model('Calculation', {
    ...
    'operand1': fields.Float(required=True, description='Operand 1'),
    'operand2': fields.Float(required=True, description='Operand 2')
})

response = api.model('Response', {
    'result': fields.Float(required=True, description='result')
})
